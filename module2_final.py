...
print(word_count('DEAR ME I WILL MAKE YOU PROUD ONE DAY..'))
...
print("QUESTION : 19 :  Find the first appearance of the substring 'not' and 'poor' from a given string, if 'not' follows the 'poor', replace the whole 'not'...'poor' substring with 'good'. Return the resulting string")
